...
namespace Bugaboo.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        {
            var ticketNotifications = db.TicketNotifications.Include(t => t.Recipient).Include(t => t.Submitter).Include(t => t.Ticket);
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,SubmitterId,RecipientId,IsRead,NotificationBody")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,SubmitterId,RecipientId,IsRead,NotificationBody")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
